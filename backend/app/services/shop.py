...
CATALOG = [
    ...
    {"id": "bg-dawn", "type": "background", "slot": "background", "name_tr": "Şafak", "name_en": "Dawn", "price": 20, "preview": {"room": "#fde7d2"}},
    {"id": "bg-meadow", "type": "background", "slot": "background", "name_tr": "Çayır", "name_en": "Meadow", "price": 20, "preview": {"room": "#e5f6d8"}},
    {"id": "bg-ink", "type": "background", "slot": "background", "name_tr": "Mürekkep", "name_en": "Ink", "price": 20, "preview": {"room": "#1a1c28"}},
